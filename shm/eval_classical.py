...
from harness import run_cv, kfold_indices, run_candidate_sandboxed, code_length, CandidateError  # noqa: E402
...
def evaluate(program_path: str) -> dict:
    try:
        ...
        cv3 = run_cv(Xtr, ytr, kfold_indices(len(ytr), 3), program_path, shm_score, SANDBOX_TIMEOUT)
        cv5 = run_cv(Xtr, ytr, kfold_indices(len(ytr), 5), program_path, shm_score, SANDBOX_TIMEOUT)
