...
Writes <out>/door_predictions.csv in the organiser format: the model is fitted on ALL labelled data and predicts the held-out set.
...
def main():
    ...
    print("wrote", Path(a.out) / "door_predictions.csv")
