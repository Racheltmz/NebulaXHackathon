"""Rail GPU-track evaluator. Same protocol as the classical track (3-fold +
...
def evaluate(program_path: str) -> dict:
    try:
        ...
        cv3 = run_cv_cloud(Xtr, ytr, stratified_kfold_indices(ytr, 3), program_path, rail_score, CLOUD_TIMEOUT)
        cv5 = run_cv_cloud(Xtr, ytr, stratified_kfold_indices(ytr, 5), program_path, rail_score, CLOUD_TIMEOUT)
